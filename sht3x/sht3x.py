...
class SHT3X:
    ...
    def read_status_register(self):
        self.__bus.write_i2c_block_data(
            self.__address, CMD_READ_STATUS_REG[0], [CMD_READ_STATUS_REG[1]]
        )
    ...
    def get_measurement(self) -> SensorData:
        ...
        self.__bus.write_i2c_block_data(
            self.__address, self.__clock_stretching, [self.__repeatability]
        )
        sleep(0.05)
